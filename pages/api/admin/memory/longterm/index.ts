...
/**
 * Vercel API Route: /api/admin/memory/longterm
 * Server-side proxy to the Render Control Plane service.
 */
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const base = `${CONTROL_BASE}/admin/memory/longterm`;
  const url = appendQuery(base, req.query);
