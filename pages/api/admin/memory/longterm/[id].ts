...
/**
 * Vercel API Route: /api/admin/memory/longterm/:id
 * DELETE -> /admin/memory/longterm/:id on control plane.
 */
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const url = `${CONTROL_BASE}/admin/memory/longterm/${encodeURIComponent(id)}`;
