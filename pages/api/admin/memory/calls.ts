...
/**
 * Vercel API Route: GET /api/admin/memory/calls
 * Server-side proxy to Control Plane: GET /admin/memory/calls
 */
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const url = appendQuery(`${CONTROL_BASE}/admin/memory/calls`, req.query);
